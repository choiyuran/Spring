...
<div class="container mt-3">
  <h2>캠핑장 등록</h2>
  <form action="${cpath }/newCampingSecond" method="POST" enctype="multipart/form-data">
    <div class="mb-3 mt-3">
      <label for="facltnm">이름:</label>
      <input type="text" name="facltnm">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
	    ...
	    <p>
			<input type="checkbox" name="induty" value="일반 야영장">
    ...
    <div class="mb-3">
    	...
    	<p>
			<input type="checkbox" name="lctcl" value="산">
				<label>산</label>
     ...
     <div class="mb-3">
      <label for="addr1">주소:</label>
		...
		<input type="text" name="addr1" placeholder="상세주소">
   	 </div>
     <div class="mb-3">
