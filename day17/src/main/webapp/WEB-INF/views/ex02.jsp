...
<script>
	async function handler(){
		...
		url += '?'
		const param = {
			servicekey:'HKRK9YDJ7lnR6pyfeLi7x1i082yjkQB%2FB5d59Zl7CCdni3tYE1Un5%2FSFDKutSKUNIsVkVEpte1ZTW4zKG3KhQw%3D%3D',
			admmCd : '2600000000',		// 행정구역 코드
			srchFrYm : '202307',		// 조회시작년월  2022.10부터 조회가능
			srchToYm : '202309',		// 조회종료년월 3개월 기간내 설정
			lv : '1',					// 광역시도 단위 : 1, 시군구 단위 : 2, 읍면동 단위 : 3, 읍면동 통반 단위 : 4
			regSeCd : '1',				// 등록구분. 전체:1, 거주자:2, 거주불명자:3, 재외국민:4(기본값 : 1)
			type : 'JSON',
			numOfRows : '10',
			pageNo : '1',
		}
	...
	// DOM내용이 모두 로드 끝나면 handler를 실해하도록한다.
